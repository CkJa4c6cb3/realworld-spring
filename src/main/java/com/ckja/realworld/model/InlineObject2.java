...
public class InlineObject2 {
   ...
   */
  public InlineObject2(List<@Valid Comment> comments) {
    this.comments = comments;
  }

  public InlineObject2 comments(List<@Valid Comment> comments) {
    this.comments = comments;
    return this;
  }

  public InlineObject2 addCommentsItem(Comment commentsItem) {
